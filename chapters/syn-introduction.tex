...
We will use `{\tt LHS}' and `{\tt RHS}' to refer to the antecedant and consequent of the
...
\circled{\small 1} and \circled{\small 2} immensely. As part of our proof discharge procedure,
...
Finally, we conclude our discussion with \cref{sec:syn-conclusion}.

then in the next section, give one section for the decomposition
then go straight into the 3 types with brief descriptions
a small subsection that tells a bit of intricasies maybe

then the final section is evaluation, try to keep as much info as possible, show the strlen example
and the results table

Conclusion is vague and takes 30mins to write (include future scope)

TODO: today i have to finish writing introduction and the evaluation section maybe?
evaluation is a lot but its also least change
...
\Cref{fig:llAllocProductCFG} shows a product-CFG,
...
Note the recursive nature of the lifting value constructor {\tt Clist}: if the pointer {\tt p} of type {\tt i32}\footnote{The IR lowers integers and pointers in C to bitvectors of type {\tt i<N>}. e.g., {\tt i32} is a 32-bit bitvector type.}
...
\subsection{Category 1: The $k$-unrolling of $P$ does not contain \recursiveRelations{}}
\label{sec:cat1}
...
\subsection{Category 2: The $k$-unrolling of $P$
...
\vspace{-6px}
\subsection{Category 3: The $k$-unrolling of $P$ contains a \recursiveRelation{} in RHS and optionally in LHS}
\label{sec:cat3}
In \cref{fig:llAllocProductCFG}, consider a proof obligation generated

...
\begin{allLangEnvScript}
  ...
  ~{\scriptsize \textcolor{mygray}{A3:}}~    if ${\tt i \geq_u n}$
  ~{\scriptsize \textcolor{mygray}{A4:}}~       then l
  ~{\scriptsize \textcolor{mygray}{A5:}}~       else make_list_impl(n, i + ${\tt 1_{i32}}$, LCons(i, l)).
  ~{\scriptsize \textcolor{mygray}{A6:}}~
  ~{\scriptsize \textcolor{mygray}{A7:}}~ fn mk_list (n:i32):List = mk_list_impl(n, ${\tt 0_{i32}}$, LNil).

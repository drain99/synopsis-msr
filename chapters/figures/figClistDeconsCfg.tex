...
\draw (125,156) node  [font=\footnotesize]  {\dpc{E_2}};
% Text Node
\draw    (180.5, 156) circle [x radius= 11.34, y radius= 11.34]   ;
\draw (180.5,156) node  [font=\footnotesize]  {\dpc{5}};
% Text Node
\draw    (203.5, 211) circle [x radius= 11.34, y radius= 11.34]   ;
\draw (203.5,211) node  [font=\footnotesize]  {\dpc{6}};
% Text Node
\draw    (228, 261) circle [x radius= 11.34, y radius= 11.34]   ;
\draw (228,261) node  [font=\footnotesize]  {\dpc{E_6}};
% Text Node
\draw (126,107.5) node  [font=\footnotesize]  {$\comv{l} = 0$};
% Text Node
\draw (184,107.5) node  [font=\footnotesize]  {$\comv{l} \neq 0$};
% Text Node
\draw (81,156.5) node  [font=\scriptsize]  {\compacttfbox{\mathbf{output}\ \cons{LNil}}};
% Text Node
\draw (217,124) node  [font=\scriptsize]  {\compacttfbox{\comv{val} \coloneqq \structPointer{\comv{l}}{\mem{}}{lnode}{\comv{val}}}};
% Text Node
\draw (274,176.5) node  [font=\scriptsize]  {\compacttfbox{\comv{tail} \coloneqq \lifted{list}{\mem{}}{lnode}{\structPointer{\comv{l}}{\mem{}}{lnode}{next}}}};
% Text Node
\draw (298,260.5) node  [font=\scriptsize]  {\compacttfbox{\mathbf{output}\ \cons{LCons}(\comv{val}, \comv{tail})}};
% Text Node
\draw (300,57) node  [font=\scriptsize]  {\compacttfbox{\comv{l} \coloneqq \structPointer{\comv{l}}{\mem{}}{lnode}{next}}};
% Text Node
\draw (120,193.5) node  [font=\scriptsize]  {\compacttfbox{\comv{tail} \coloneqq \cons{LNil}}};
% Text Node
\draw (110,250) node  [font=\scriptsize]  {\compacttfbox{\comv{tail} \coloneqq \cons{LCons}(\comv{val}, \comv{tail})}};
% Text Node
\draw (112,54) node  [font=\scriptsize]  {\compacttfbox{\mathbf{input}\ \comv{l}, \mem{}}};
% Connection

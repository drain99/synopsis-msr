...
\node[draw,circle,inner sep=0.4mm,minimum size=6mm,font=\footnotesize,label={-95,inner sep=0.4mm:\footnotesize \compacttfbox{\mathbf{output} \  \cons{LNil}}}] (2) [position=-110:10mm from 1] {\dpc{E_2}};
...
\draw  [-{Straight Barb[length=2.2mm, width=1.5mm]},dash pattern={on 2.5pt off 2.5pt}] (2) .. controls ++(-60:9mm) .. node[near end,left,font=\footnotesize,xshift=1.2mm,yshift=-2mm] {\compacttfbox{{\tt tail} \coloneqq \cons{LNil}}} (4);
...
\draw  [-{Straight Barb[length=2.2mm, width=1.5mm]},dash pattern={on 2.5pt off 2.5pt}] (3) .. controls ++(0:65mm) and ++(0:40mm) .. node[right,near end,font=\footnotesize,yshift=3mm] {\compacttfbox{l \coloneqq \structPointer{l}{\mem{}}{lnode}{next}}} (0);

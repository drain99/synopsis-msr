...
% Text Node
\draw (76,156.5) node  [font=\footnotesize]  {\tfbox{\mathbf{output}\ \cons{LNil}}};
% Text Node
...
% Text Node
\draw (307,260.5) node  [font=\footnotesize]  {\tfbox{\mathbf{output}\ \cons{LCons}(\comv{val}, \comv{tail})}};
% Text Node
...
% Text Node
\draw (90,236.5) node  [font=\footnotesize]  {\tfbox{\comv{tail} \coloneqq \cons{LCons}(\comv{val}, \comv{tail})}};
% Text Node
\draw (110,55.5) node  [font=\footnotesize]  {\tfbox{\mathbf{input}\ \comv{l}, \mem{}}};
% Connection

...
\hline
\hline
% \multicolumn{2}{|c|}{\Tstrut \BBstrut \inv{T1} {\tt List = LNil | LCons(i32, List)}} \\
% \hline
...
% \hline
% \hline
% \multicolumn{2}{|c|}{\Tstrut \BBstrut \inv{T2} {\tt Tree = TNil | TCons(i32, Tree, Tree)}} \\
% \hline
...
\hline
% \hline
% \multicolumn{2}{|c|}{\Tstrut \BBstrut \inv{T4} {\tt Matrix = MNil | MCons(List, Matrix)}} \\
% \hline
...
\end{tabular}
\end{scriptsize}
\caption{\label{tab:LiftingConsStr}Examples of lifting constructors and their definitions.}
\vspace{-18px}
\end{table}
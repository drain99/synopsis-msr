...
\Cref{tab:llproductInv} lists the invariants for the product-CFG in \cref{fig:llAllocProductCFG}.
...
and invariant inference (\curved{A3}) based on prior work \cite{oopsla20}.
...
\Cref{sec:conclusion} concludes our work by reiterating the key ideas presented, alongside some related work.

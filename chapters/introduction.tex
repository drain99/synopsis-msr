...
The \type{List} ADT in the \SpecL{} program is defined at line {\tt A0} in \cref{fig:llAllocSpec}.
...
The \SpecL{} procedure {\tt mk\_list} (defined at line {\tt A6} in \cref{fig:llAllocSpec}), takes
...
\label{sec:contribs}
As previously summarized in \cref{sec:motivatingexample}, a bisimulation based proof of equivalence

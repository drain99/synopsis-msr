...
\lstdefinelanguage{All}[]{C}{
  morekeywords={if,then,else,match,with,let,in,fn,type,i32,i8,bool,false,true,List,Tree,Mat,size\_t,BITOP,lnode,Str,OptStr,clnode,u32,is,assume,assuming,do,sizeof,offsetof,typeof,addrof}
}

...
\newcommand{\fdv}[1]{\ensuremath{{\tt #1}^{f}}}%
\newcommand{\sdv}[1]{\ensuremath{{\tt #1}^{s}}}%
...
\newcommand*{\compacttfbox}[1]{\setlength{\fboxsep}{2pt}\fbox{\ensuremath{#1}}}
...
\newcommand{\olifield}[1]{{\textcolor{myolive}{\field{#1}}}}%

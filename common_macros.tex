...
\newcommand{\cfgpath}[1]{\ensuremath{{\tt \rho_{#1}}}}%
\newcommand{\pc}[1]{\ensuremath{{\tt #1}}}%
...
\newcommand{\prodpc}[2]{\ensuremath{{\tt #1\!:\!#2}}}%
...
\newcommand{\prodedge}[4]{\ensuremath{{\small (\prodpc{#1}{#2}) \! \rightarrow \! (\prodpc{#3}{#4})}}}%
...
\newcommand{\ttedge}[2]{{\ensuremath{[#1 \! : \! {\tt #2}]}}}%
\newcommand{\vtedge}[3]{{\ensuremath{[#1 \! : \! {\tt #2} ; #3]}}}%
...
\newcommand{\ubfree}[1]{{\ensuremath{{\tt ubfree}(#1)}}}%
\newcommand{\execpaths}[3]{{\ensuremath{{\tt EP}_{#1}(#2,#3)}}}%
\newcommand{\func}[1]{{\tt #1()}}%
\newcommand{\fref}[2]{{\tt #1()} in L#2}%
\newcommand{\qcount}[1]{{\ensuremath{\mathbf{\mathcal{Q}_{#1}}}}}%
\newcommand{\btcount}{{\ensuremath{\mathcal{P}_{B\!T}}}}%
\newcommand{\minapprox}[1]{{\ensuremath{\mathbf{d}_{#1}}}}%
\newcommand{\stime}[2]{\the\numexpr#1*60+#2\relax}%
...
\newcommand*{\curvedtype}[1]{\tikz[baseline=(char.base)]{
                      \node[shape=rounded rectangle,draw,inner sep=3pt] (char) {#1};}}

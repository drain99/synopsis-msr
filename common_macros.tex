...
\lstdefinelanguage{All}[]{C}{
  morekeywords={if,then,else,match,with,let,in,fn,type,i32,i8,List,lnode,Str,clnode}
}

\lstnewenvironment{allLangEnvScript}{\lstset{language=All,basicstyle=\footnotesize\ttfamily,mathescape=true}}{}
...
\newcommand{\sumDtor}{\underline{if}-\underline{then}-\underline{else}}%
